        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex bg-white/5 p-0.5 sm:p-1 rounded-xl sm:rounded-2xl border border-white/5">
            <button 
              ...
              className={`px-3.5 py-2 sm:px-4 sm:py-2 rounded-lg sm:rounded-xl text-[10px] sm:text-[10px] font-black uppercase tracking-widest transition-all touch-manipulation ${viewMode === 'Yashwanth' ? 'bg-indigo-500 text-white shadow-lg' : 'text-white/30'}`}
            >
              Yash
            </button>
            <button 
              onClick={() => setViewMode('Lahari')}
              className={`px-3.5 py-2 sm:px-4 sm:py-2 rounded-lg sm:rounded-xl text-[10px] sm:text-[10px] font-black uppercase tracking-widest transition-all touch-manipulation ${viewMode === 'Lahari' ? 'bg-indigo-500 text-white shadow-lg' : 'text-white/30'}`}
            >
              Lahari
            </button>
            <button 
              onClick={() => setViewMode('Global')}
              className={`px-3.5 py-2 sm:px-4 sm:py-2 rounded-lg sm:rounded-xl text-[10px] sm:text-[10px] font-black uppercase tracking-widest transition-all touch-manipulation ${viewMode === 'Global' ? 'bg-indigo-500 text-white shadow-lg' : 'text-white/30'}`}
            >
              Team
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {viewMode !== 'Global' && (
              <button onClick={() => setIsStreakPageOpen(true)} className="flex items-center gap-1.5 sm:gap-2 bg-orange-500/10 text-orange-500 px-2.5 sm:px-3 py-1.5 sm:py-1.5 rounded-full border border-orange-500/20 active:scale-90 transition-transform touch-manipulation">
                <Flame size={14} className="sm:w-3.5 sm:h-3.5" fill="currentColor" />
                <span className="font-black text-[10px] sm:text-[10px] tracking-widest">{streakData.current}D</span>
              </button>
            )}
            ...
            <button onClick={() => setIsMenuOpen(true)} className="w-10 h-10 sm:w-10 sm:h-10 flex items-center justify-center bg-white/5 rounded-xl sm:rounded-2xl border border-white/5 active:scale-90 transition-all touch-manipulation">
              <Menu size={20} className="sm:w-5 sm:h-5 text-white/60" />
            </button>
          </div>
        </div>
      </header>
